...
<html lang="pl">
    ...
    <![endif]-->
    <!--[if gt IE 8]><!-->
        <link rel="stylesheet" href="{$config->app_url}/css/layouts/marketing.css">
    <!--<![endif]-->

    <link rel="stylesheet" href="{$config->app_url}/css/style.css">
{if $hide_intro }
    <link rel="stylesheet" href="{$config->app_url}/css/style_hide_intro.css">
{/if}
	
	<link rel="stylesheet" href="http://netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css">

	<script src="{$config->app_url}/js/jquery.min.js"></script>
	<script src="{$config->app_url}/js/softscroll.js"></script>
    ...
    <body>
        ...
        <div id="app_top" class="header">
           <div class="home-menu pure-menu pure-menu-open pure-menu-horizontal pure-menu-fixed">
                <a class="pure-menu-heading" href="">{$page_header|default:"Tytuł"}</a>
                <ul>
